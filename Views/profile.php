                ...
                <div class="profile-work">
                    ...
                    <?php if ($_SESSION['type'] == 'G') { ?>
                        ...
                        <form action="<?php echo FRONT_ROOT . "User/updatePrice/" ?>" method="POST">
                            ...
                            <label><br> <b>Price per day</b> </label><br>
                            $<input type="number" name="price" min="0" max="9999" placeholder="999" required>
                            <br><br>

                            <input type="submit" name="submit" class="profile-edit-btn" value="Save Price" />
                        </form>
                    <?php } ?>
                </div>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <?php if ($user->getFirstAvailableDay() != null && $user->getLastAvailableDay() != null) { ?>
                                        <label>
                                    <?php echo "From: " . $user->getFirstAvailableDay() . "<br>To: " . $user->getLastAvailableDay();
                                    }
                                } ?></label>
                                </div>
                            </div>
