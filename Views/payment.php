            ...
            <div class="col-xs-12 col-md-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="<?php echo FRONT_ROOT . "Booking/confirmBooking/" ?>" method="POST" role="form">
                            ...
                            <div class="comment-pay">
                                <span style="text-align: center; display:block;">This payment only covers 50% of the
                                    stay</span>
                            </div>
                        </form>
                    </div>
