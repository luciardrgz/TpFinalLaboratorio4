      ...
      <div class="col-md-8">
         <div class="card">
               ...
               <h5>Guardian Information</h5>
                  <table class="table table-borderless">
                     <tbody>
                        <tr>
                           <td>
                              <div class="py-2"> <span class="d-block text-muted">Booking Date</span> <span><?php echo $firstDay . " to " . $lastDay?></span> </div>
                           </td>
                           <td>
                              <div class="py-2"> <span class="d-block text-muted">Guardian Name</span> <span><?php echo $guardian->getFirstName();?></span> </div>
                           </td>
                        </tr>
                     </tbody>
                  </table>
                        ...
                        <tr>
                           ...
                           <td width="60%">
                              ...
                              <div class="product-qty"> 
                                <span class="d-block">Breed: <?php echo $breed->getBreedName($pet->getBreed()); ?></span> 
            ...
            <div class="d-flex justify-content-between footer p-3"> 
                <a href="#" class="btn d-block w-100 d-sm-inline-block btn-success">Confirm</a>
            </div>
            <div class="d-flex justify-content-between footer p-3"> 
