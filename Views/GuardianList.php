                            ...
                            <div class="filter-result">
                                <div class="info-box d-md-flex align-items-center justify-content-between mb-30">
                                    <div class="job-left my-4 d-md-flex align-items-center flex-wrap">
                                        ...
                                        <div class="job-content">
                                            ...
                                            <ul class="d-md-flex flex-wrap ff-open-sans">
                                                <li class="mr-md-4">
                                                    <img src="https://img.icons8.com/material/24/null/user-male-circle--v1.png" />
                                    ...
                                    <div class="job-right my-4 flex-shrink-0">
                                        <a href="<?php echo FRONT_ROOT . "Booking/bookDate/" . $guardian->getId() . "/" . $firstDay . "/" . $lastDay ?>" class="btn d-block w-100 d-sm-inline-block btn-light">Hire</a>
                                    </div>
                                </div>
                            <?php
                        }
